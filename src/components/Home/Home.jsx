    ...
    <div className="flex items-center justify-center  ">
      <div className="text-center   p-4 rounded-xl ">
        ...
        <p className="text-black-600 mb-4">
          I am a passionate developer and machine learning enthusiast. Currently, I work remotely as a Machine Learning Fellow at Bytewise Limited. I thrive on solving real-world problems by shaping them into effective web solutions, blending my skills in both development and machine learning.
        </p>
